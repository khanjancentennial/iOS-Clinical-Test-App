...
class DeleteClinicalTestViewModel: ObservableObject {
//    @Published var patientId: String = ""
    ...
    func deletePatient(testId: String,completion: @escaping (Bool) -> Void) {
        isLoading = true
        
        guard let url = URL(string: "https://group3-mapd713.onrender.com/api/clinical-tests/clinical-tests/\(testId)") else {
            isLoading = false
